...
- [Fluent Bit with Kubernetes](https://www.manning.com/books/fluent-bit-with-kubernetes) - An all-practical guide to monitoring both cloud-native and traditional environments with Fluent Bit.
