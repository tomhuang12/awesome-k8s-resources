...
- :green_heart:[Projectsveltos](https://github.com/projectsveltos/addon-manager) :fire: Projectsveltos is an open-source project aimed at managing Kubernetes add-ons, facilitating the deployment of both Helm charts and resource YAMLs across multiple clusters.
