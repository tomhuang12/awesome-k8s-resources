...
- [Humalect](https://humalect.com/) - Humalect helps you go from code to cloud native deployments on k8s without worrying about k8s specific details in minutes. End to end DevOps pipelines delivering Infrastructure creation, CI/CD, deployments, auto-scalability and observability. 
