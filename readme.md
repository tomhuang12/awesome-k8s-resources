...
- [Humalect](https://humalect.com/) - Devs get superpowers of DevOps using Humalect. Humalect helps you go from code to cloud native deployments on k8s without worrying about k8s specific details in minutes. End to end DevOps pipelines starting from Infrastructure creation, to CI/CD, deployment and observability. 
